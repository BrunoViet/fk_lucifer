...
export const FAQ_DATA = [
  {
    ...
    answer:
      "The following products qualify for one random Galaxy Card with purchases of USD 25, or a full non-duplicate set with purchases of USD 70. Limited quantity available, first come, first served.\nAET x Alien Stage - Mechanical Keycap Blind Box\nAlien Stage - Free Stage Series Plush Toy\nAET x Alien Stage - TWS Wireless Earphones\nAET x Alien Stage - Free Stage Silicon Earphone Case",
  },
  {
    question: "Is there a minimum spend threshold?",
    answer:
      "There is no minimum purchase requirement, but a spending threshold may apply to qualify for prizes or giveaways.",
  },
  {
    question: "Are the galaxy/black/bunny cards: Random inside blind boxes?",
    answer:
      "For eligible orders, the card will be shipped together with the product.",
  },
  {
    question:
      "Bonuses based on purchase amount? Exclusive to in-person purchases only?",
    answer:
      "Part of the bonuses are based on purchase amount, and part are randomly drawn. Customers who purchase event products during the event period will all have a chance to win prizes.",
  },
  {
    question: "Is this a gacha system or fixed rewards?",
    answer:
      "The giveaway mostly follows a Gacha System. For example, The 1st prize will have 6 winners in total: 3 reserved for the top 3 highest-spending customers in the store, and 3 drawn randomly from all customers who made purchases during the event period.\nIf an autograph by the author is won during the pop-up store event, it will be given to the top spender. If we win two autographs, one will be given to the top spender and the other to a random winner. If there are three autographs, the second top spender will receive one, and so on.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "After the event ends, buyers can go to orderstatus.harum.io to request combined shipping and get a refund for excess shipping fees.",
  },
  {
    question: "Is the anniversary popup official or just speculation?",
    answer:
      "The Malaysia pop-up event is officially organized by the brand; we are acting as the proxy buyer.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "For any updates about the Malaysia pop-up event, please visit our social media channels including Instagram, Facebook, and Twitter under the name <b>harumiokorea.<b/>",
  },
];
...
export const FAQ_ANI = [
  ...
  {
    question:
      "Will the official ANIPLUS × Alien Stage purchase bonuses still be included?",
    answer:
      "Yes, it depends on how many bonus items we are able to secure through proxy purchases.",
  },
  {
    question:
      "What kind of additional event-exclusive gifts will be available?",
    answer:
      "The list of point redemption items will be updated regularly based on character points. Please stay tuned for announcements.",
  },
  {
    question: "Do I need to spend a minimum amount to qualify for the gifts?",
    answer:
      "There are different gift tiers. The entry-level tier requires only a small purchase amount.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Points from blind box items will be evenly distributed among all characters.",
  },
  {
    question: "Are the event gifts limited in quantity?",
    answer:
      "Yes. Availability depends on our stock, and the gift list will be adjusted accordingly.",
  },
  {
    question: "Will gifts be shipped together with my order or separately?",
    answer:
      "Gifts will be shipped together with your order. To redeem, you must select an unshipped order at checkout.",
  },
  {
    question: "Can I choose which gift I receive?",
    answer:
      "Yes, you can redeem gifts of your choice based on the points you’ve accumulated.",
  },
  {
  ...
  {
    question:
      "Can I combine this event with discount codes or other promotions?",
  ...
  {
    question:
      "If I place multiple orders, can they be combined and the shipping fee refunded?",
    answer:
      "Yes, we do support combined shipping, but only after the event has ended. You will be able to request combined shipping and a refund for excess shipping fees at orderstatus.harum.io.",
  },
];
