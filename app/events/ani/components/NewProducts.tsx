...
import PointsBg from "@/public/images/ani/new_bg.png";
  ...
  return (
    <section className="w-full m-[2rem_0]">
      ...
      <div className="w-full relative flex justify-center items-center">
        ...
        {!loading && !error && (
          <div className="h-full flex items-center absolute inset-0 left-0 right-0 py-30 max-sm:py-10 pl-16 pr-16 max-sm:pl-12 max-sm:pr-12">
            <Carousel
              options={{ loop: true }}
              ref={carouselRef}
